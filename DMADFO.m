...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% DMADFO.m %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [x,f,info] = DMADFO(fun,x,st,tune);
%
...
%              %     -1: nothing, 0: litte, >=1: more and more
% 
function [xbest,fbest,info] = DMADFO(fun,x,st,tune);
persistent m n dim 
%%%%%%%%%%%%%%%%%%%%%%%%
%%%% initial checks %%%%
%%%%%%%%%%%%%%%%%%%%%%%%
...
if isempty(fun)
  message = 'DMADFO needs the function handle fun to be defined';
  disp(message)  
  return
